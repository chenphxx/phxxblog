/**
 * 由 design/themes/tokens.mjs 生成前端主题 CSS。
 *
 * 为什么要有生成器:
 *   主题从 3 套涨到 11 套之后, 每套手写 400 行 CSS 既重复又会漂移(改一处忘一处)。
 *   这里把「与主题无关的结构」抽成模板, 只让令牌数据变化, 保证 11 套主题的
 *   增强层完全一致、只有配色与圆角/阴影/动效参数不同。
 *
 * 用法: node design/themes/generate-themes.mjs
 * 输出: frontend/src/styles/themes/theme-<id>.css
 *      frontend/src/styles/themes/registry.ts  (主题清单, 供前端下拉菜单用)
 */
...
const outDir = path.join(repo, 'frontend/src/styles/themes')
 ...
 * ${t.desc}
 * ------------------------------------------------------------
 * 本文件由 design/themes/generate-themes.mjs 生成, 请勿手改。
 * 改配色/圆角请改 design/themes/tokens.mjs, 然后重新运行:
